...
DcsBios::StringBuffer<25> dedLine1Buffer(0x4502, onDedLine1Change);

void onDedLine2Change(char* newValue) {
  line2 = newValue;
  bufferChanged = true;
}
DcsBios::StringBuffer<25> dedLine2Buffer(0x4520, onDedLine2Change);

void onDedLine3Change(char* newValue) {
  line3 = newValue;
  bufferChanged = true;
}
DcsBios::StringBuffer<25> dedLine3Buffer(0x453e, onDedLine3Change);

void onDedLine4Change(char* newValue) {
  line4 = newValue;
  bufferChanged = true;
}
DcsBios::StringBuffer<25> dedLine4Buffer(0x455c, onDedLine4Change);

void onDedLine5Change(char* newValue) {
  line5 = (newValue);
  bufferChanged = true;
}
DcsBios::StringBuffer<25> dedLine5Buffer(0x457a, onDedLine5Change);
